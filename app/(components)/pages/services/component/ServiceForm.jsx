...
const ServiceForm = ({ formTranslate, formContactData, code }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="flex flex-col bg-[#D5BA8C] p-[4rem] lg:p-[2.5rem] rounded-[1rem]">
        <div className="mb-[2rem] md:mb-[1.8rem]">
          <h3 className="text-[2.4rem] md:text-[2.2rem] text-[#FFFFFF] font-[600] mb-[2rem]">
            {formTranslate?.contact_page}
          </h3>
          <p className="text-[1.8rem] md:text-[1.6rem] text-[#FFFFFF] font-[600]">
        ...
        <div className="flex flex-col">
          <input
            ...
            className="w-[406px] lg:w-full mb-[2rem] text-[1.4rem] md:text-[1.2rem] font-[600] py-[1.3rem] px-[1.6rem] rounded-[0.4rem] outline-none placeholder:text-[#011E41]"
          />
          ...
          <input
            ...
            className="w-[406px] lg:w-full mb-[2rem] md:mb-[1.5rem] text-[1.4rem] md:text-[1.2rem] font-[600] py-[1.3rem] px-[1.6rem] rounded-[0.4rem] outline-none placeholder:text-[#011E41]"
          />
