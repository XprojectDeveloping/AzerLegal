        ...
        <div className="relative">
          <div className="bg-[#011E41] right-[10.2rem] top-[-8rem] rounded-[9rem] py-[5.5rem] px-[3.2rem] absolute">
            <Image
              width={100}
              height={100}
              src={`${process.env.NEXT_PUBLIC_PICTURE}/${SliderText?.logo}`}
              alt="logo"
            />
          </div>
          <div className="abosulte">
            <img
              src={`${process.env.NEXT_PUBLIC_PICTURE}/${SliderText?.video_background}`}
              alt="video"
            />
            <Link href={SliderText?.video_url} target="_blank">
